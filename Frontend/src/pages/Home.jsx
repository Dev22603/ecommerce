...
const Home = () => {
    ...
    const handleSearch = async (page = 1) => {
        ...
        try {
            ...
            let result;
            if (searchType === "name") {
                result = await productService.getProductsByName(searchQuery, page);
            } else {
                result = await productService.getProductsByWsCode(searchQuery, page);
            }
...
//         if (!searchQuery.trim()) {
//             fetchProducts(1); // Reset to default fetch if search is empty
//             return;
//         }
...
//             let result;
//             if (searchType === "name") {
//                 result = await productService.getProductsByName(searchQuery);
//             } else {
//                 result = await productService.getProductsByWsCode(searchQuery);
//             }
//             // setProducts(result);
