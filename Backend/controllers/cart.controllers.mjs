// import { Cart, Product } from "../models/index.mjs"; // Import Sequelize models
import { Cart} from "../models/cart.mjs"; // Import Sequelize models
import { Product } from "../models/product.mjs"; // Import Sequelize models
	...
	try {
		...
		if (cartProducts.length === 0) {
			return res
				...
				.json({
					message:
						"No products found in your cart for recommendations.",
				});
		}
